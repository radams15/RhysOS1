...
void Idt::init_idt(){
    ...
    Memory::memset((uint8)&idt_entries, 0, sizeof(idt_entry_t)*256);
    ...
    Serial::write("Initialised IDTs\n");
}

void Idt::idt_set_gate(uint8 num, uint32 base, uint16 sel, uint8 flags)
{
